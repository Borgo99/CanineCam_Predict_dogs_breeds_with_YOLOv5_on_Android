...
public class PrePostProcessor {
    ...
    private static int mOutputColumn = 25 + 5; // left, top, right, bottom, score and 80 class probability
    private static float mThreshold = 0.2f; // score above which a detection is generated
